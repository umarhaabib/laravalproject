            ...
            <div class="row register-new-row">
                <div class="col-sm-12 col-md-6 col-lg-7">
                    <div class="register-desc">
                        ...
                        <h1>Can't Found </h1>
                        <h2> </h2>
                        <p>Sorry, we were not able to find a user with that username and password. </p>
                    </div>
                </div>
        ...
        <div class="tab-pane fade show active" id="registerForm" role="tabpanel" aria-labelledby="registerForm">
            ...
            <form action="{{URL::to('')}}/tetenter/save" method="post" class="onboarding-form" name="registrationForm" id="registrationForm" >
                ...
                <div class="form-group text-center pt-2 mb-4">
                    ...
                    <div class="">
                        <a href = "../home/terms.html" class = color-green target = _blank>EstateGuru User Terms</a> and <a href = "../home/privacy.html" class = color-green target = _blank>EstateGuru Privacy Rules </a> 
                    </div>
                </div>
                ...
                <div class="form-group text-center mt-4 mb-3">
                    ...
                    <div class="message-box warning-message-box alert alert-dismissible mt-3" hidden="hidden" id="divRecaptchaBotDetected">
                        ...
                        <p>
                            If you're sure you're human, please contact info@estateguru.co, and our support team will help you to get back into your account.
                        </p>
                    </div>
                </div>
