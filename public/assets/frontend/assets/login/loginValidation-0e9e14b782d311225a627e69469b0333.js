...
console.debug('login validation manifest loaded...');

$(document).ready(function () {
    "use strict";

    var loginForm = new FormValidation('loginForm');
    var registrationForm = new FormValidation('registrationForm');
    loginForm.init(['emailValidator']);
    registrationForm.init(['emailValidator']);
